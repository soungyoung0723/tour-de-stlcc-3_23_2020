DROP DATABASE IF EXISTS Health98;
CREATE DATABASE Health98;
USE Health98;
...
INSERT INTO tblroutewithsteps VALUES (8, 'STLCC -Corporate College
',' 3221 McKelvey Rd, Bridgeton, MO 63044
',20,42240,73206,'false');

INSERT INTO tblroutewithsteps VALUES (9, 'St.Louis Lambert International Airport
','2645 Generations Dr, Grover, MO 63040
',4.4,9293,82579,'false');


INSERT INTO tblroutewithsteps VALUES (10, "Musick Park
",' 8617 Latty Ave, Hazelwood, MO 63042
',4.6,9715,92294,'false');

INSERT INTO tblroutewithsteps VALUES (11, "'Imo's Pizza
'",' 1939 Washington St, Florissant, MO 63033
',2.1,4435,96730,'false');

INSERT INTO tblroutewithsteps VALUES (12, 'STLCC - Florissant Valley'
,'3400 Pershall Rd, St. Louis, MO 63135',1.5,3168,99898,'false');

INSERT INTO tblroutewithsteps VALUES (13, 'Koeneman Park',
'8937 Lucas and Hunt, Jennings, MO 63136',4.9,10349,110246,'false');

INSERT INTO tblroutewithsteps VALUES (14, "'O'Fallon Park'",
'10701 Lambert International Blvd, St. Louis, MO 63145',
5, 10560,120806,'false');

INSERT INTO tblroutewithsteps VALUES (15, 'Griot Museum of Black History
',' 2505 St Louis Ave, St. Louis, MO 63106',
2.5, 5280,126086,'false');

INSERT INTO tblroutewithsteps VALUES (16, 'STLCC - Harrison Park',
' 3140 Cass Ave, St. Louis, MO 63106',1.1, 
'2323',128410,'false');

INSERT INTO tblroutewithsteps VALUES (17, 
'Contemporary Art',
' 3750 Washington Blvd, St. Louis, MO 63108',1.0,2112,130522,'false');

INSERT INTO tblroutewithsteps VALUES (18, "'Pappy's Smokehouse'",
'3106 Olive St, St. Louis, MO 63103',0.8,1690,132211,'false');

INSERT INTO tblroutewithsteps VALUES (19, 'Ikea',
'1 Ikea Way, St. Louis, MO 63110',1.4,2957,135168,'false');

INSERT INTO tblroutewithsteps VALUES (20, 'STLCC - Forest Park campus',
'5600 Oakland Ave, St. Louis, MO 63110',2.3,4858,140026,'false');

INSERT INTO tblroutewithsteps VALUES (21, 'St.Louis Zoo',
'Government Dr, St. Louis, MO 63110',1.6, 3379,143405,'false');

INSERT INTO tblroutewithsteps VALUES (22, "'Eat at Gus' Pretzels'",
'1820 Arsenal St, St. Louis, MO 63118',6.3,13306,156710,'false');

INSERT INTO tblroutewithsteps VALUES (23, "Ted Drewes",
